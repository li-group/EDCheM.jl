...
Consumer = ["j1","j2","j3","j4","j5","j6","j7","j8"]
Supplier = ["j1","j2","j3","j7"]
...
sp_prfac = 1
wt_prfac = 3
max_sp_pl = 2 #Ratio of maximum number of solar panels to plants in a location
max_wt_pl = 2 #Ratio of maximum number of solar panels to plants in a location
max_pl = 1 #maximum number of plants in a location in the final configuration
ir = 0.03
mw = Dict()
